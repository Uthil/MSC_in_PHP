        ...
        <div class="container-fluid">
                    ...
                    <nav class="navbar navbar-inverse navbar-expand-lg justify-content-center">
                        ...
                        <ul class="navbar-nav">
                            ...
                            if ($role === 'Φοιτητής') {
                                ...
                                echo "<li><a href='ypovoli_ergasias.php' style='background-color:rgb(129, 139, 139);' class='nav-link'>Υποβολή Εργασίας</a></li>";
                            } else {
            ...
            <div class="row" style="border:1px solid;width:30%;margin:auto;padding-left: 10px;padding-top: 10px;">
                <form method="POST" action="dimiourgia_ekfonisis.php">
                    ...
                    <p><b>Περιγραφή:</b><br>
                        <textarea name="perigrafi" rows="7" style="width: 95%" placeholder="Πληκτρολογήστε περιγραφή για την εργασία"></textarea>
                    </p>
                    <p><b>Μάθημα:</b><br>
                    ...
                    <p><b>Εργασία:</b><br>
                        <select name="ergasia" style="width: 95%">
                            <?php
